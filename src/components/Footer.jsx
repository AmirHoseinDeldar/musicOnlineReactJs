...
const Footer = () => {
  return (
    <>
      <div
        className='flex h-fit  justify-between text-right mr-16 text-white  '
        style={{
      ...
      >
        ...
        <div className=' mt-20 xl:hidden  '>
          ...
          <p>
            لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم <br /> از صنعت چاپ و
            با استفاده از <br /> طراحان گرافیک است.{' '}
          </p>
        ...
        <div className=' mt-20 mr-3 xl:hidden'>
          <h1 style={{ color: ' #3bc8e7' }} className='mb-4'>
            Midelar
          </h1>
          <p className=''>
            ...
            <br />
            از طراحان گرافیک است. چاپگرها <br />و متون بلکه روزنامه و مجله{' '}
            <br />
      ...
      <p className='flex justify-center text-white'>
        تمامی حقوق این سایت متعلق به امیرحسین دلدار میباشد MidelarMusic طراحی{' '}
      </p>
    </>
  );
};
